...
#ifndef VISION_PROBLEM_152_H
#define VISION_PROBLEM_152_H

#include "vignette_generator.h"
#include "vision_problem_tools.h"

class VisionProblem_152 : public VignetteGenerator {
  static const int part_size = Vignette::width / 12;
  static const int hole_size = Vignette::width / 64;
  static const int exclusive_length = Vignette::width / 8;
public:
  VisionProblem_152();
