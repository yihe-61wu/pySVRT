...
VisionProblem_52::VisionProblem_52() { }

void VisionProblem_52::generate(int label, Vignette *vignette) {
  int max_nb_shapes = 8;
  int min_nb_shapes = 5;
  ...
  do {
    ...
    xs[0] = int(random_uniform_0_1() * Vignette::width);
    ys[0] = int(Vignette::height - random_uniform_0_1() * exclusive_length);
    scales[0] = max_scale;
    ...
    for(int n = 1; n < nb_shapes; n++) {
      ...
      ys[n] = int(random_uniform_0_1() * (Vignette::height - exclusive_length));
